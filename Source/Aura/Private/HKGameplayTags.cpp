...
void FHKGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.Attributes_Secondary_BlockChance = UGameplayTagsManager::Get().AddNativeGameplayTag(
		...
		FString("Chance to block incoming damage in half"));
	...
	*/
	...
	GameplayTags.Effects_HitReact = UGameplayTagsManager::Get().AddNativeGameplayTag(
		...
		FString("Tag Granted when in Hit Reaction"));
	...
	*/
	...
	GameplayTags.Abilities_Type_Support = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Abilities.Type.Support"),
		FString("Type Support"));
