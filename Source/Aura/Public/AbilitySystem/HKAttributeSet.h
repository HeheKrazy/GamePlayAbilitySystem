...
// typedef is specific to the FGameplayAttribute() signature, but TStatucFuncPtr is generic to any signature chosen
...
public:
	...
	ATTRIBUTE_ACCESSORS(UHKAttributeSet, IncomingXP);
	/* End Meta Attributes */
	...
	ATTRIBUTE_ACCESSORS(UHKAttributeSet, ArmorPenetration);

	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_BlockChance, Category = "Secondary Attributes")
	FGameplayAttributeData BlockChance;
	ATTRIBUTE_ACCESSORS(UHKAttributeSet, BlockChance);
	...
	ATTRIBUTE_ACCESSORS(UHKAttributeSet, CriticalHitResistance);
